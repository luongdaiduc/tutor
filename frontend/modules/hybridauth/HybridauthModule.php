...
// 			'providers' => $this->providers,
			'providers' => array ( 
                ...
                "google" => array ( 
                    "enabled" => true,
                    "keys"    => array ( "id" => $settings['google_api_key'], "secret" => $settings['google_api_secret'] ),
                    "scope"   => ""
                ),
 
                "facebook" => array ( 
                    "enabled" => true,
                    "keys"    => array ( "id" => $settings['facebook_api_key'], "secret" => $settings['facebook_api_secret'] ),
                ...
                "twitter" => array ( 
                    "enabled" => true,
                    "keys"    => array ( "key" => $settings['twitter_api_key'], "secret" => $settings['twitter_api_secret'] ),
                ),
			),
		);
	}
