<div class="span10">
	<div>
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo Common::translate('account', 'Login Details')?></li>
		</ul>
	</div>
	...
	<div class="row-fluid">
		<div class="span12">
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				<?php $this->renderPartial('/register/_account', array('form'=>$form, 'model'=>$model))?>
